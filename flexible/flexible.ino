...
*/
const uint8_t infoServiceUuid128[] =               { 0x1a, 0x22, 0x00, 0x01, 0xc2, 0xed, 0x4d, 0x11, 0xad, 0x1e, 0xfc, 0x06, 0xd8, 0xa0, 0x2d, 0x37 };
const uint8_t infoServiceEpochChrUuid128[] =       { 0x1a, 0x22, 0x00, 0x02, 0xc2, 0xed, 0x4d, 0x11, 0xad, 0x1e, 0xfc, 0x06, 0xd8, 0xa0, 0x2d, 0x37 };
const uint8_t infoServiceSpecVersionChrUuid128[] = { 0x1a, 0x22, 0x00, 0x03, 0xc2, 0xed, 0x4d, 0x11, 0xad, 0x1e, 0xfc, 0x06, 0xd8, 0xa0, 0x2d, 0x37 };
const uint8_t infoServiceSpecIdChrUuid128[] =      { 0x1a, 0x22, 0x00, 0x04, 0xc2, 0xed, 0x4d, 0x11, 0xad, 0x1e, 0xfc, 0x06, 0xd8, 0xa0, 0x2d, 0x37 };
...
*/
const uint8_t randomNumberServiceUuid128[] =          { 0x1a, 0x23, 0x00, 0x01, 0xc2, 0xed, 0x4d, 0x11, 0xad, 0x1e, 0xfc, 0x06, 0xd8, 0xa0, 0x2d, 0x37 };
const uint8_t randomNumberServiceDataChrUuid128[] =   { 0x1a, 0x23, 0x00, 0x02, 0xc2, 0xed, 0x4d, 0x11, 0xad, 0x1e, 0xfc, 0x06, 0xd8, 0xa0, 0x2d, 0x37 };
const uint8_t randomNumberServiceConfigChrUuid128[] = { 0x1a, 0x23, 0x00, 0x03, 0xc2, 0xed, 0x4d, 0x11, 0xad, 0x1e, 0xfc, 0x06, 0xd8, 0xa0, 0x2d, 0x37 };
...
void setupInfoService()
{
  ...
  uint8_t specVersion[3] = { 0x00, 0x03, 0x02 };
...
{ 
  ...
  randomNumberDataBuf[rnCursor++] = (rnLastRecordedMS) && 0xff;
  // Serial.print("Recording random number -> value: ");
  // Serial.print(value);
  // Serial.print(" cursor: ");
  // Serial.println(rnCursor);
}
